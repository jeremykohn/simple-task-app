...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Simple task management application built with Nuxt 4"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Task List App"};
